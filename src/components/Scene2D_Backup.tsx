...
export const Scene2D: React.FC<Scene2DProps> = ({ measurements, measurementMode }) => {
  ...
  const getModelMeasurements = () => {
    ...
    // Provide defaults for missing detailed measurements
    const defaults = {
      male: {
        headCircumference: 58, neckCircumference: 38,
        chestCircumference: 100, waistCircumference: 85, hipCircumference: 95,
        armLength: 63, wristCircumference: 17, palmLength: 19, middleFingerLength: 8,
      ...
      female: {
        ...
        armLength: 58, wristCircumference: 15, palmLength: 17, middleFingerLength: 7,
      ...
      other: {
        ...
        armLength: 60, wristCircumference: 16, palmLength: 18, middleFingerLength: 7,
        legLength: 81, thighCircumference: 56, ankleCircumference: 23, toeLength: 25,
      }
    };

    const genderDefaults = defaults[measurements.gender];
    
    return {
      height: measurements.height,
      weight: measurements.weight,
      headCircumference: detailed.headCircumference || genderDefaults.headCircumference,
      neckCircumference: detailed.neckCircumference || genderDefaults.neckCircumference,
      chestCircumference: detailed.chestCircumference || genderDefaults.chestCircumference,
      waistCircumference: detailed.waistCircumference || genderDefaults.waistCircumference,
      hipCircumference: detailed.hipCircumference || genderDefaults.hipCircumference,
      armLength: detailed.armLength || genderDefaults.armLength,
      wristCircumference: detailed.wristCircumference || genderDefaults.wristCircumference,
      palmLength: detailed.palmLength || genderDefaults.palmLength,
      middleFingerLength: detailed.middleFingerLength || genderDefaults.middleFingerLength,
      legLength: detailed.legLength || genderDefaults.legLength,
      thighCircumference: detailed.thighCircumference || genderDefaults.thighCircumference,
      ankleCircumference: detailed.ankleCircumference || genderDefaults.ankleCircumference,
      toeLength: detailed.toeLength || genderDefaults.toeLength,
    };
  };
